...
class linearSystem(om.ImplicitComponent):
    ...
    def apply_nonlinear(self, inputs, outputs, residuals):
        ...
        [                                          np.zeros(nn),                               M*np.sin(Phi)*(h - rt),                   M,                                                                                                                                                                                                                                                                               M*V*n*tau*np.sin(alpha + np.cos(alpha)) + M*V*np.sin(Phi)*np.sin(alpha + np.cos(alpha))*(h - rt)*(tau*np.cos(alpha) + nu*np.sin(alpha))],
        [-M*(Beta*(rt - z) - Beta*np.cos(Phi)*(h - rt)), Ixx + M*((h - rt)**2 + np.cos(Phi)*(h - rt)*(rt - z)), M*np.sin(Phi)*(h - rt), M*((V*np.cos(Phi) + V*n*tau*np.sin(Phi)*np.sin(alpha + np.cos(alpha)))*(h - rt) - V*(rt - z) + V*np.sin(alpha + np.cos(alpha))*(tau*np.cos(alpha) + nu*np.sin(alpha))*(z**2 - r*rt*z) + V*np.sin(alpha + np.cos(alpha))*(h - rt)**2*(tau*np.cos(alpha) + nu*np.sin(alpha)) + 2*V*np.cos(Phi)*np.sin(alpha + np.cos(alpha))*(h - rt)*(tau*np.cos(alpha) + nu*np.sin(alpha))*(rt - z)) + Ixx*V*np.sin(alpha + np.cos(alpha))*(tau*np.cos(alpha) + nu*np.sin(alpha))]])

        b = np.array([[Fx - M*(sdot*(alphadot*nu*np.sin(alpha) + alphadot*tau*np.cos(alpha)) + (nu*np.cos(alpha) - tau*np.sin(alpha))*(k*ndot - Beta*V*np.cos(alpha + np.cos(alpha))*(alphadot - alphadot*np.sin(alpha))))*(rt - z + np.cos(Phi)*(h - rt)) + M*Omega_z*(Beta*V + sdot*(tau*np.cos(alpha) + nu*np.sin(alpha))*(rt - z)) - (Cd*V**2*rho)/2 - 2*M*sdot*zdot*(nu*np.cos(alpha) - tau*np.sin(alpha)) - M*g*sig*np.cos(alpha) + M*Omegadot_z*np.sin(Phi)*(h - rt) + 2*M*Phidot*(h - rt)*(Omega_z*np.cos(Phi) - sdot*np.sin(Phi)*(nu*np.cos(alpha) - tau*np.sin(alpha))) - M*n*sdot**2*tau*(nu*np.cos(alpha) - tau*np.sin(alpha)) - M*sdot**2*np.sin(Phi)*(h - rt)*(tau*np.cos(alpha) + nu*np.sin(alpha))*(nu*np.cos(alpha) - tau*np.sin(alpha)) + M*Omega_z*sdot*np.cos(Phi)*(h - rt)*(tau*np.cos(alpha) + nu*np.sin(alpha))],
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                [Fy + M*(sdot*(alphadot*tau*np.sin(alpha) - alphadot*nu*np.cos(alpha)) + (tau*np.cos(alpha) + nu*np.sin(alpha))*(k*ndot - Beta*V*np.cos(alpha + np.cos(alpha))*(alphadot - alphadot*np.sin(alpha))))*(rt - z + np.cos(Phi)*(h - rt)) - M*Omega_z*(V - sdot*(nu*np.cos(alpha) - tau*np.sin(alpha))*(rt - z)) + 2*M*sdot*zdot*(tau*np.cos(alpha) + nu*np.sin(alpha)) + M*np.sin(Phi)*(sdot**2*(tau*np.cos(alpha) + nu*np.sin(alpha))**2 + Omega_z**2)*(h - rt) + M*g*sig*np.sin(alpha) + (Cl*V**2*rho*np.sin(Phi))/2 + M*Phidot**2*np.sin(Phi)*(h - rt) + M*n*sdot**2*tau*(tau*np.cos(alpha) + nu*np.sin(alpha)) + M*Omega_z*sdot*np.cos(Phi)*(h - rt)*(nu*np.cos(alpha) - tau*np.sin(alpha)) + 2*M*Phidot*sdot*np.sin(Phi)*(h - rt)*(tau*np.cos(alpha) + nu*np.sin(alpha))],
