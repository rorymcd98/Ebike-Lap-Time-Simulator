...
class powerTrain(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input('sig_R', val=0.001, desc='resistance temperature lapse', units=None)#guess
        self.add_input('sig_kV', val=-0.001, desc='bemf constant temperature lapse', units=None)
        self.add_input('sig_kt', val=-0.001, desc='torque constant temperature lapse', units=None)
        ...
        #states
        self.add_input('e', val=np.zeros(nn), desc='battery energy', units='J')
        self.add_input('T', val=np.zeros(nn), desc='system temperature', units='C')
